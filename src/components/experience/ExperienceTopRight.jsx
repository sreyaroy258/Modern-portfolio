const ExperienceTopRight = () => {
  return (
    <div className="xl:w-[25%] lg:w-[30%] w-full border border-lightBrown p-6 rounded-xl">
      <p className="text-base sm:text-lg text-center text-lightGrey leading-relaxed">
        I specialize in{" "}
